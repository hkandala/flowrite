...
export function CodeBlockElement(props: PlateElementProps<TCodeBlockElement>) {
  ...
  return (
    <PlateElement
      ...
      {...props}
    >
      <div className="relative border rounded-md bg-muted-foreground/10 dark:bg-muted/50">
        <pre className="overflow-x-auto p-8 pr-4 font-mono leading-relaxed [tab-size:2] print:break-inside-avoid">
