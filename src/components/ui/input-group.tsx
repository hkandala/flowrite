...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group border-input dark:bg-input/20 relative flex w-full items-center rounded-md border shadow-xs transition-[color,box-shadow] outline-none",
...
const inputGroupButtonVariants = cva(
  "text-sm shadow-none flex gap-2 items-center cursor-pointer",
  {
    variants: {
      size: {
