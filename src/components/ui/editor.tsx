  ...
  ),
  {
    ...
    variants: {
      ...
      variant: {
        ...
        fullWidth:
          "size-full px-8 pb-72 text-base sm:px-[max(64px,calc(50%-40ch))]",
        none: "",
...
// custom scroll that uses 'nearest' to avoid centering
const scrollSelectionIntoView: PlateContentProps["scrollSelectionIntoView"] = (
  _editor,
  domRange,
) => {
