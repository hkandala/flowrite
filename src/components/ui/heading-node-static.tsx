...
const headingVariants = cva("relative mb-1", {
  variants: {
    variant: {
      h1: "mt-[0.75em] pb-px font-heading text-3xl font-bold tracking-tight",
      h2: "mt-[0.75em] pb-px font-heading text-2xl font-semibold tracking-tight",
      h3: "mt-[0.75em] pb-px font-heading text-xl font-semibold tracking-tight",
