...
export const ToolbarToggleGroup = React.forwardRef<
  React.ComponentRef<typeof ToolbarPrimitive.ToolbarToggleGroup>,
...
function withTooltip<T extends React.ElementType>(Component: T) {
  const ExtendComponent = React.forwardRef<HTMLElement, TooltipProps<T>>(
    (
      ...
      const componentProps = { ref, ...props } as React.ComponentProps<T>;
  ...
  ExtendComponent.displayName = `withTooltip(${typeof Component === "string" ? Component : (Component as { displayName?: string }).displayName || "Component"})`;
